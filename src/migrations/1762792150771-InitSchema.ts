...
export class InitSchema1762792150771 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "locations" ADD CONSTRAINT "FK_9f238930bae84c7eafad3785d7b" FOREIGN KEY ("parentId") REFERENCES "locations"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD CONSTRAINT "FK_788929ed61ab78bb914f0d1931b" FOREIGN KEY ("categoryId") REFERENCES "categories"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" ADD CONSTRAINT "FK_b5370c1c1b56e3f3ef84038096e" FOREIGN KEY ("defaultLocationId") REFERENCES "locations"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_record_items" ADD CONSTRAINT "FK_a2cdc33b35cd547c081d2263924" FOREIGN KEY ("recordId") REFERENCES "usage_records"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_record_items" ADD CONSTRAINT "FK_2126dea8728dd5d85bd373849f4" FOREIGN KEY ("itemId") REFERENCES "items"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_record_items" ADD CONSTRAINT "FK_d44fa391b893e0137ae88354288" FOREIGN KEY ("locationId") REFERENCES "locations"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_records" ADD CONSTRAINT "FK_f7243be3cb838b13d4f2a63dc9a" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_record_items" ADD CONSTRAINT "FK_1ec83e287b7c5b5c31bdf2ad4fc" FOREIGN KEY ("recordId") REFERENCES "purchase_records"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_record_items" ADD CONSTRAINT "FK_1ec58e124d6fbf4a98295c98557" FOREIGN KEY ("itemId") REFERENCES "items"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_record_items" ADD CONSTRAINT "FK_70fe48786dcb4a8035e857e5942" FOREIGN KEY ("locationId") REFERENCES "locations"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_records" ADD CONSTRAINT "FK_0e255e9890f49fcf4d673545c0a" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "stock" ADD CONSTRAINT "FK_623dbc561abc7fade5a85931712" FOREIGN KEY ("itemId") REFERENCES "items"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "stock" ADD CONSTRAINT "FK_9092d6a8d81644af4a17c5ee9fc" FOREIGN KEY ("locationId") REFERENCES "locations"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "stock_adjustments" ADD CONSTRAINT "FK_cf5fdde818126d81389ed52bb50" FOREIGN KEY ("stockId") REFERENCES "stock"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "stock_adjustments" ADD CONSTRAINT "FK_ffcab531cd75f7559af2f209038" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "stock_adjustments" DROP CONSTRAINT "FK_cf5fdde818126d81389ed52bb50"`,
    );
    await queryRunner.query(
      `ALTER TABLE "stock" DROP CONSTRAINT "FK_9092d6a8d81644af4a17c5ee9fc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "stock" DROP CONSTRAINT "FK_623dbc561abc7fade5a85931712"`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_records" DROP CONSTRAINT "FK_0e255e9890f49fcf4d673545c0a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_record_items" DROP CONSTRAINT "FK_70fe48786dcb4a8035e857e5942"`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_record_items" DROP CONSTRAINT "FK_1ec58e124d6fbf4a98295c98557"`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchase_record_items" DROP CONSTRAINT "FK_1ec83e287b7c5b5c31bdf2ad4fc"`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_records" DROP CONSTRAINT "FK_f7243be3cb838b13d4f2a63dc9a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_record_items" DROP CONSTRAINT "FK_d44fa391b893e0137ae88354288"`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_record_items" DROP CONSTRAINT "FK_2126dea8728dd5d85bd373849f4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "usage_record_items" DROP CONSTRAINT "FK_a2cdc33b35cd547c081d2263924"`,
    );
    await queryRunner.query(
      `ALTER TABLE "items" DROP CONSTRAINT "FK_b5370c1c1b56e3f3ef84038096e"`,
    );
    await queryRunner.query(
